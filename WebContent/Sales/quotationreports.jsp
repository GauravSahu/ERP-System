...
<title>Sales :: QuotationReports</title>
...
<table width="950" cellpadding="0" cellspacing="0" align="center" class="para" border="1" rules="all">
 <tr height="50">
 <html:form action="salesmodule.do?action=quotationresults">
 <td colspan="6">
 <br />
...
<br /><br />
 ...
 <logic:notEmpty name="quotationreports">
 <tr bgcolor="#999999" height="30" align="center" >
 <td width="134"><b> SL.No</b></td>
 <td width="286"><b>Date</b></td>
 <td width="227"><b> Inquiry Name</b></td>
 <td width="227"><b>Requirements</b></td>
 <td width="227"><b>User name</b></td>
  <td width="227"><b>Service Type </b></td>
  <td width="227"><b>Quotation</b></td>
  <td width="227"><b>File Name</b></td>
 <logic:iterate id="role" name="quotationreports" indexId="index">
 </tr>
 ...
 <td><bean:write name="role" property="requirements"/> </td>
  <td><bean:write name="role" property="username"/></td>
    ...
    <td><a href='DownloadIt.do?&filename=<bean:write name="role" property="fname"/>&vlu=pc'><bean:write name="role" property="fname"/></a></td>

</logic:iterate>
 </tr>
</logic:notEmpty> 
<logic:present name="quotationreports">
			<logic:empty name="quotationreports">
