...
<title>Sales Module : Follow Up </title>
...
<link rel="stylesheet" type="text/css"
	...
	{		
		...
		if(document.forms[0].enquiryid.value=="-1")
		{
			alert("Please select enquiryname");
			document.forms[0].enquiryid.focus();
			return false;
		} 

		if(document.forms[0].userid.value=="-1")
		{
...
<html:form action="salesmodule.do?action=addFollowup" onsubmit="return validateForm();">
  <table align="center">
...
<font color="blue"><bean:write name="status"/></font>
   ...
   <tr></tr>
		...
		<tr>
		  ...
		  <td height="40" width="100">Follow up Date * :</td>
 <td><input type="text" name="fdate" value="" id="calendar1" class="calendarFocus"/></td>
		 ...
		 <td width="150">Assigned To * :</td><td> <html:select property="userid" styleClass="select1">
		  ...
		  <td colspan="2"  height="40">Details : <textarea name="followupdetails" cols="30"  onkeypress="return isAlpha(event);" style=" resize:none;border-radius:10px;margin-left:40px; margin-top:10px;" rows="5"  >
		  </textarea>
		  </td>
		  </tr>
		   <tr>
