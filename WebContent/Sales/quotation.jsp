...
<html:form action="salesmodule.do?action=addQuatation" onsubmit="return validateForm();" enctype="multipart/form-data">
<table align="center">
  ...
  <table border="0" width="700"cellpadding="0" cellspacing="0" align="right" style="margin-right:50px; background-color:#D5E396; padding:12px; border-radius:40px; margin-top:15px;">
   <tr></tr>
		...
		<tr>
		   ...
		   <td colspan="2"  height="40">Quotation Details : <textarea name="qdetails" cols="30"  onkeypress="return isAlpha(event);" style=" resize:none;border-radius:10px;margin-left:40px; margin-top:10px;" rows="5"  >
		  </textarea>
		  </tr>
		  <tr>
		  		  <td width="150">Price  :</td><td> <input type="text" style="border-radius:8px;" name="price" size="25"  maxlength="5"   onkeypress="return isAlpha(event);"/></td>    
	              	  <td><html:file property="fileupload" ></html:file></td>
		  </tr>
		 <tr>
        <td></td>
        <td></td>
