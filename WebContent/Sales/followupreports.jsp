...
<title>Sales :: Follow up Reports</title>
...
<table width="950" cellpadding="0" cellspacing="0" align="center" class="para" border="1" rules="all">
 <tr height="50">
 <html:form action="salesmodule.do?action=followupresults">
 <td colspan="6">
...
<br /><br />
 ...
 <logic:notEmpty name="followupreports">
 ...
 <logic:iterate id="role" name="followupreports" indexId="index">
 </tr>
...
<logic:present name="followupreports">
			<logic:empty name="followupreports">
