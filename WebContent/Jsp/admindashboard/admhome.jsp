...
<%
	...
	try {
		...
		if (rs1.next()) {
			...
			st1.close();
			 String filePath = request.getContextPath()+"/"+"images"+"/test.jpg";
			 System.out.println("_______________"+filePath);
		           // getServlet().getServletContext().getRealPath("/")+"downloadpdf"+"/ex.pdf";
...
<a href="<%=request.getContextPath()%>/images/test.jpg "></a>
</div>
<!-- header_logo -->
...
<table width="1010" height="45" style="margin-top: 10px;">
 ...
 <html:form action="Login.do?action=home1" method="post" > 
	<td width="208" height="39" class="text4">SCode :&nbsp;
		  ...
		  <input type="submit" value="" name="submit" style="background:url(images/ok.png); background-repeat:no-repeat; cursor:pointer; height:27px; width:27px; border:none;"></td>   
</html:form>	   
...
<table>
	<tr>
		...
		<td width="29"><a href="https://www.twitter.com"><img src="images/ierp_twt.PNG"
			border="0" /></a></td>

		<td width="29"><a href="https://www.facebook.com"><img src="images/ierp_fb.PNG"
			border="0" /></a></td>

		<td width="29"><a href="http://www.youtube.com"><img src="images/ierp_u.PNG"
			border="0" /></a></td>
	</tr>
