...
function validate()
{
	...
	if(document.forms[0].firstName.value.trim()==""){
		...
		document.forms[0].firstN ame.focus();
		return false;
	}
	...
	if(document.forms[0].dayOfJoining.value.trim()==""){
		alert("EmailID1 cannot be empty");
		document.forms[0].dayOfJoining.focus();
		return false;
	}
	if(document.forms[0].dayOfBirth.value.trim()==""){
		alert("EmailID2 cannot be empty");
		document.forms[0].dayOfBirth.focus();
		return false;
	}
	if(document.forms[0].persentAddress.value.trim()==""){
		alert("Website cannot be empty");
		document.forms[0].website.focus();
		return false;
	}
	
	if(document.forms[0].permanentAddress.value==""){
