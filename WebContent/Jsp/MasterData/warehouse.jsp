...
function edit(id,fname,add,tno,mono,eid1,eid2,web,discount,tax){
	//alert("HI");
	//alert(id);
	//alert(fname);
	//alert(lname);
	...
	document.forms[0].action="Warehouse.do?action=update";
...
document.forms[0].action="Warehouse.do?action=add";
...
function slctcity()
{
	document.forms[0].action="Warehouse.do?action=list";
...
<html:form action="/Warehouse.do?action=add">
...
<table width="950" border="0" cellspacing="0" cellpadding="0" align="center" class="para">
  <tr>
        ...
        <td><input type="text" name="firstname" id="textfield" style="width:120px;"/>  <input type="hidden" name="vendorid" /></td>
         ...
         <td>Address</td>
        <td>:</td>
        <td align="left"><input type="text" name="address" style="width:120px;"/></td>
   </tr>
   <tr>
				...
				<logic:iterate id="vendor" name="vendorList" indexId="index">
					<tr class="para" >
						...
						<td align="left" style="color: black"><bean:write
							name="vendor" property="firstname" /></td>
							<td align="left" style="color: black"><bean:write
						...
						<td align="center"><logic:equal name="vendor"
							property="active" value="true">
<a href='Warehouse.do?action=changestatus&amp;vendorid=<bean:write name="vendor" property="vendorid"/>&amp;active=false'><input type="submit"  value="Remove" style="background:#666; color:#fff;"/></a>
<a href='#' onclick='edit("<bean:write name="vendor" property="vendorid"/>","<bean:write name="vendor" property="firstname"/>","<bean:write name="vendor" property="address"/>","<bean:write name="vendor" property="teleno"/>","<bean:write name="vendor" property="mobileno"/>","<bean:write name="vendor" property="emailid1"/>","<bean:write name="vendor" property="emailid2"/>","<bean:write name="vendor" property="website"/>")'><input type="submit"  value="Edit" style="background:#666; color:#fff;"/></a>
						</logic:equal> 
						<logic:equal name="vendor" property="active" value="false">
							<a href='Warehouse.do?action=changestatus&amp;vendorid=<bean:write name="vendor" property="vendorid"/>&amp;active=true'><input type="submit"  value="Activate" style="background:#666; color:#fff;"/></a>
						</logic:equal>&nbsp;</td>
					</tr>
				</logic:iterate>
			</table>
