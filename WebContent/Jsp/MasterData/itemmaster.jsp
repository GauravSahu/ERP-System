...
<html:form action="Itemmaster.do?action=add" onsubmit="return validateForm()">
<table>
<tr>
<input type="hidden" name="itemmasterid"  /> 
<td><label>Item Category:</label>
					<html:select  property="categoryid"  styleId="categoryid" styleClass="select1" onchange="fetch2()">
						<html:option value="-1">--Item Category--</html:option>
						<html:options collection="itemcategorylist" property="categoryid"	labelProperty="categoryname" />
					</html:select></td>
 ...
 <logic:notEmpty name="itemmasterlist">
 <tr bgcolor="#999999" height="30" align="center" >
 <td ><b>SL No</b></td>
 <td ><b>ITEM CATEGORY ID</b></td>
 <td><b>ITEM NAME </b></td>
  <td><b>STATUS</b></td>
   <td><b>ACTION</b></td>
 </tr>
 <logic:iterate id="itemmasterform" name="itemmasterlist" indexId="index">
 <tr align="center" height="25">
 <td><%=index+1 %></td> 
 <td><bean:write name="itemmasterform" property="categoryid"/></td>
 <td><bean:write name="itemmasterform" property="itemname"/></td>

  <td><logic:equal name="itemmasterform" property="active" value="true">
	  <font color="green">Active</font>
	 </logic:equal> 
	 <logic:equal name="itemmasterform" property="active" value="false">
	 <font color="red">InActive</font>
	 </logic:equal></td>
	 
<td>
 <logic:equal name="itemmasterform" property="active" value="true">
<a href='Itemmaster.do?action=changestatus&amp;itemmasterid=<bean:write name="itemmasterform" property="itemmasterid"/>&amp;active=false' style="text-decoration:none;"  ><input type="submit"  value="Remove" style="background:#666; color:#fff;"/></a>
								&nbsp;&nbsp;
<td><a href='#'	onclick='edit("<bean:write name="itemmasterform" property="itemmasterid"/>","<bean:write name="itemmasterform" property="categoryid"/>","<bean:write name="itemmasterform" property="itemname"/>")' style="text-decoration:none" ><input type="submit"  value="Edit" style="background:#666; color:#fff;"/></a></td>
</logic:equal> 
<logic:equal name="itemmasterform" property="active" value="false">
<a href='Itemmaster.do?action=changestatus&amp;itemmasterid=<bean:write name="itemmasterform" property="itemmasterid"/>&amp;active=true' style="text-decoration:none;"><input type="submit"  value="Activate" style="background:#666; color:#fff;"/></a>
</logic:equal> 
 </logic:iterate>
 </logic:notEmpty> 
