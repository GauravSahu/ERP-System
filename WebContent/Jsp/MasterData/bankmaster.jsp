...
{	
	 ...
	 // document.getElementById("status").innerHTML="";
		document.forms[0].action="Bank.do?action=update";
		document.forms[0].bankId.value=countryid;
		document.forms[0].bankName.value=countryname;
		document.forms[0].btn.value="Update";
 }
function validate()
{

	if(document.forms[0].bankName.value.trim()=="")
	{
	...
	if (!document.forms[0].bankName.value.match(/^[a-zA-Z ]*$/) && document.forms[0].bankName.value !="")
    {
 	   document.forms[0].bankName.value="";
 	   document.forms[0].bankName.focus(); 
       alert("Please Enter only alphabets in the Bank Name text field");
       return false;   
    }
}
...
<td align="left" style="padding-left:20px;"> Welcome <%
 ...
 %></td>
<td align="center"><img src="images/Bankmaster.png"/></td>
...
<div id="city_content">
 ...
 <td colspan="4">
 <html:form action="/Bank.do?action=add">
 <logic:notEmpty name="status">
					<font color="blue"><bean:write name="status"></bean:write></font>
				</logic:notEmpty>
 Bank Name :

 <input type="text" name="bankName" id="textfield" />
 <input type="hidden" name="bankId" id="textfield" />
 &nbsp;&nbsp; 
   &nbsp;&nbsp; <input type="submit"  name="btn" onclick="return validate()"  value="Save" style="background:#666; color:#fff;"/>
 ...
 <td width="134"><b> BANK ID</b></td>
 <td width="286"><b>BANK NAME</b></td>
 ...
 <td><%=index+1 %></td>
 <td><bean:write name="role" property="bankName"/></td>
 ...
 <logic:equal name="role" property="active" value="true">
							<a href='Bank.do?action=changestatus&amp;bankId=<bean:write name="role" property="bankId"/>&amp;active=false' style="text-decoration:none;"  ><input type="submit"  value="Remove" style="background:#666; color:#fff;"/></a>
								&nbsp;&nbsp;
								<a href='#'	onclick='edit("<bean:write name="role" property="bankId"/>","<bean:write name="role" property="bankName"/>")' style="text-decoration:none" ><input type="submit"  value="Edit" style="background:#666; color:#fff;"/></a>
						     </logic:equal> 
						     
						     <logic:equal name="role" property="active" value="false">
							<a
								href='Bank.do?action=changestatus&amp;bankId=<bean:write name="role" property="bankId"/>&amp;active=true' style="text-decoration:none;"><input type="submit"  value="Activate" style="background:#666; color:#fff;"/></a>
						</logic:equal> 
 </logic:iterate>
 </logic:notEmpty> 
