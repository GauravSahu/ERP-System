...
<td align="left" style="padding-left:20px;"> Welcome to <%
 ...
 %></td>
<td align="center"><img src="images/timesheetModule.png" border="0" /></td>
...
<table width="950" cellpadding="0" cellspacing="0" align="center" class="para" border="1" rules="all">
 <tr height="50">
 <td colspan="6">
 <html:form action="/timesheet.do?action=reports1">
 <br />
From Date:
...
<br /><br />
 ...
 &nbsp;&nbsp;<input type="submit"  value="Generate Report" style="background:#666; color:#fff;"/>
 <br /><br />
   </td>
  </html:form>
 </tr>
 ...
 <td width="227"><b>Date</b></td>
 <td width="227"><b>Task's List</b></td>
<logic:iterate id="role" name="AttList" indexId="index">
 ...
 <td><bean:write name="role" property="applied"/></td>
 <td><bean:write name="role" property="timesheet"/></td>
 </logic:iterate>
 </logic:notEmpty> 
 </tr>
