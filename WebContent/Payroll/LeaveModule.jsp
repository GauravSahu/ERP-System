...
<td align="left" style="padding-left:20px;"> Welcome to <%
 ...
 %></td>
<td align="center"><img src="../images/leavemodule_payroll.png" /></td>
...
<td height="50" colspan="2"></td>
      ...
      <td width="227" align="center"><html:link action="leave.do?action=leaveRequest"><img src="../images/leave_Request.png" /></html:link></td>
    <td><html:link action="leave.do?action=leavestatus"><img src="../images/leave_Status.png" /></html:link></td>
</tr>
</tr>
      <td width="227" align="center"><html:link action="leave.do?action=leaveHistory"><img src="../images/leave_history.png" /></html:link></td>
    <td><html:link action="leave.do?action=fetchLeaveRequest"><img src="../images/leave_approval.png" /></html:link></td>
</tr>
