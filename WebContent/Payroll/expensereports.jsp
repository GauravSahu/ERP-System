...
<td align="left" style="padding-left:20px;"> Welcome to <%
 ...
 %></td>
<td align="center"><img src="images/expen_report.png" border="0"  /></td>
...
<br />
 <html:form action="expenseModule.do?action=reports1">
...
<br /><br />
 ...
 <td width="134"><b> SL.No</b></td>
  <td width="286"><b>Name</b></td>
 <td width="286"><b>Applied Date</b></td>
 <td width="227"><b>Expense Date</b></td>
 <td width="227"><b>Status</b></td>
  <td width="227"><b>Amount</b></td>
   <td width="227"><b>Reason</b></td>
 <td width="227"><b>Reason for rejection </b></td>
 ...
 <td><bean:write name="role" property="tDate"/> </td>
  <td><bean:write name="role" property="status"/> </td>
    <td><bean:write name="role" property="amount"/> </td>
